        ...
        <div class = "card-wrapper mr-5">
            ...
            <div class = "task-holder">
                ...
                <div style={{"position": "absolute", "top":"160px", "left":"160px"}}>
                    <button style={{"color" : colors[index%3].primaryColor, "cursor" : "pointer"}} onClick = {() => setModal(true)}>Update</button>
                    <button style = {{"color" : colors[index%3].primaryColor, "cursor" : "pointer"}} onClick = {handleDelete}>Delete</button>
                </div>
        </div>
